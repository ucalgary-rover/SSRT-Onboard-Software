...
int EasyProfile::On_SendPkg(
    EP_CMD_TYPE_ txPkgCmd,  ///< [INPUT]   Specify the relevant data structre to be sent. (e.g.
                            ///< EP_CMD_REQUEST_)
 ...
 *         EP_NORMAL_EXIT_   No new package received, no error occurred / package ignored due to
 * RecvFilter policy EP_MUTEX_LOCKED_  Read / Write permission denied EP_FAIL_          Bad package
 * / Bad header received
 */
